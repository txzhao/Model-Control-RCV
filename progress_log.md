...
|:----------:|:-----------------------|
| 1 | - Identify Input/Output variables to the MPC controller in dSpace. 
- Identify Input variables to the ROS simulator. (BONUS: Try to implement a simple PI-controller.) | 
