...
| 3 | <ul><li>Upgrade the PI-controller in ROS to an MPC-controller, and verify on a non linear path. </li><li> Connect output from dSpace to input in ROS. |
